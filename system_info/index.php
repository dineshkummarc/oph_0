...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="content[welcome_message]" class="control-label">Welcome Message</label>
				<textarea type="text" class="form-control form-control-sm summernote" name="content[welcome_message]" id="welcome_message"><?php echo  is_file(base_app.'welcome_message.html') ? file_get_contents(base_app.'welcome_message.html') : '' ?></textarea>
			</div>
